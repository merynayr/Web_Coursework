...
$(document).ready(function() {
    ...
    // $("#createFlightContainer").load("src/components/Popups/CreateFlight.html");
    $("#editFlightContainer").load("src/components/Popups/EditItem.html");
    $("#removeFlightContainer").load("src/components/Popups/RemoveItem.html");
    ...
    $('#createNewFlightButton').on('click', () => {
        // Handle create new flight popup
        alert('Create new flight popup');
    });
});
